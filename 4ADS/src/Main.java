...
public class Main {
    ...
    public static void main(String[] args) {
	    Reader reader = new Reader("C:\\Users\\Gytis\\eclipse-workspace\\4ADS\\src\\Grafas.txt");
    ...
    private static boolean dfs(String first, String second, ArrayList<Person> people) {
